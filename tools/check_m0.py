...
RUNMODE_BASELINE = {
    "R2": (80, "PENDING_BUILD：20 份 Manifest × 4 个构建版本字段，M0 设计内（执行规格 §〇）"),
    "R11": (10, "PENDING_RESIGN_P0-6 占位残留：P0-6 Founder 重签时一次性替换，重签前必然在"),
    "R12": (20, "approved_at 命中已撤回的签字时间戳：同样待 P0-6 重签后回填，重签前必然在"),
}
